...
function render(variables = {}) {
  variables.background = "https://picsum.photos/300/200";
  ...
  variables.avatarURL = `https://randomuser.me/api/portraits/women/${avatarId}.jpg`;
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h2>
            ${variables.role == null ? "Role description" : variables.role}
          </h2>
          <h3>
